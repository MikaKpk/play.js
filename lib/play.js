...
if(typeof exports === 'undefined'){
  ...
  */
  ...
  Play.prototype.sound = function sound (file, callback) {
    ...
    if (!this.playerName && this.checked === this.playerList.length) {
      console.log('An Error occured: No known command line audio player installed!.'.red);
      console.log('Make sure you have one of these:'.red, this.playerList)
    ...
    child.on('exit', function (code, signal) {
      if(code == null || signal != null || code === 1) {
        console.log('An error occured: ' + '[code: '+ code + '] ' + '[signal: ' + signal + '] :' + this.playerName.cyan);
